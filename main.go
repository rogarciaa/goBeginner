...
func main() {
	...
	for {
		...
		if isValidName && isValidEmail && isValidTicketNumber {
			...
			wg.Add(1)
			go sendTicket(userTickets, firstName, lastName, email) // go command give this func concurrency - flows continues while the time sleep counts and proceed once finished
...
func greetUsers() {
	...
	fmt.Printf("We have a total of %v ticlets and %v are still available.\n", conferenceTickets, remainingTickets)
